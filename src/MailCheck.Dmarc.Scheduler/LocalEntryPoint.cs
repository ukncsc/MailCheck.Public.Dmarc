...
namespace MailCheck.Dmarc.Scheduler
{
    public static class LocalEntryPoint
    {
        ...
        {
            command.Description = "Execute CloudWatch triggered DMARC scheduler lambda code locally.";

            command.OnExecute(async () =>
            {
                DmarcPeriodicSchedulerLambdaEntryPoint entryPoint = new DmarcPeriodicSchedulerLambdaEntryPoint();
        ...
        {
            command.Description = "Execute SQS triggered DMARC scheduler lambda code locally.";
            ...
            command.OnExecute(async () =>
            {
                DmarcSqsSchedulerLambdaEntryPoint entryPoint = new DmarcSqsSchedulerLambdaEntryPoint();
        ...
        private static async Task ProcessMessages(CommandOption queueUrl,
            DmarcSqsSchedulerLambdaEntryPoint entryPoint,
