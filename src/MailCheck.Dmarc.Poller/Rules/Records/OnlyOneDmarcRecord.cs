    ...
    public class OnlyOneDmarcRecord : IRule<DmarcRecords>
    {
        ...
        public Task<List<Error>> Evaluate(DmarcRecords records)
        {
            ...
            errors.Add(records.Records.Count > 1
                ...
                : new Error(Id, "mailcheck.dmarc.noDmarcRecord", ErrorType.Error, string.Format(DmarcRulesResource.NoDmarcErrorMessage, records.Domain), string.Format(DmarcRulesMarkdownResource.NoDmarcErrorMessage, records.Domain)));
