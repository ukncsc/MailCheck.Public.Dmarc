...
using MailCheck.Dmarc.Entity.Seeding.DomainCreated;
using MailCheck.Dmarc.Entity.Seeding.History;
using Microsoft.Extensions.CommandLineUtils;

namespace MailCheck.Dmarc.Entity
{
    public static class LocalEntryPoint
    {
        public static void Main(string[] args)
        {
            ...
            commandLineApplication.Command("seed", command =>
            {
                ...
                CommandOption newDmarcConnectionString = command.Option("-nd", "new Dmarc Connection String", CommandOptionType.SingleValue);


                command.OnExecute(() =>
                {
                    IHistoryMigrator historyMigrator =
                        HistoryMigratorFactory.Create(dmarcConnectionString.Value(), newDmarcConnectionString.Value());
